    ...
    <aside className="w-[260px] shrink-0 hidden md:flex flex-col bg-white dark:bg-slate-900 border-l border-slate-200/70 dark:border-slate-700/70 sidebar-shadow">
      ...
      <div className="p-4 border-t border-slate-100 dark:border-slate-700/70">
        ...
        <button
          ...
          className="mt-3 w-full flex items-center justify-center gap-2 text-sm font-semibold py-2.5 rounded-xl text-rose-600 border border-rose-100 dark:border-rose-800/60 bg-rose-50/70 dark:bg-rose-900/20 hover:bg-rose-100 dark:hover:bg-rose-900/40"
